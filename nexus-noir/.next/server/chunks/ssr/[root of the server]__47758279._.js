...
"[project]/src/app/journal/[slug]/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function BlogPostPage() {
    ...
    const post = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockPosts"].find((p)=>p.slug === slug);
    // We'll fetch the markdown file and store its text here
    const [mdContent, setMdContent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    // Fetch the .md file when the component mounts
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (post && post.contentPath) {
            fetch(post.contentPath).then((res)=>res.text()).then((text)=>setMdContent(text)).catch((err)=>console.error('Error loading markdown:', err));
        }
    }, [
        post
    ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__47758279._.js.map